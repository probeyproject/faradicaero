...
import { FaTwitter, FaFacebook, FaVimeo } from "react-icons/fa"; // Import icons from react-icons
...
const TeamMemberItem = ({ member }) => (
  <div className="group relative">
    ...
    <div className="absolute -bottom-12 left-[10%] p-5 w-[80%] bg-white shadow-xl dark:bg-slate-800 text-center overflow-hidden z-[1] group-hover:bg-gray-400 group-hover:pt-7 group-hover:px-5 group-hover:pb-20 duration-300 group-hover:text-white">
